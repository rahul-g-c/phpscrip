...
<head>
	...
	<title>Claritiz Innovations | Strategic Design Partner</title>
...
<!-- End Google Tag Manager -->
    ...
    <!-- Header -->
    <header class="hdr-bg5">
        <div class="container">
            <div class="intro-text">
            <br><br>
                <h1 class="intro-lead-in"><span>Change Agents</span>, Design Thinkers and <span>Innovators</span></h1>
                <div class="intro-cont">We help startups and enterprises to create meaningful products</div><br><br><br><br><br>
                  <!-- Partner to Envision your Innovative ideas!</div><br><br><br><br><br> -->
               <!--<img src="img/banner-img.jpg" alt="">-->
            </div>
        </div>
    </header>

	<!--<div class="section white-bg small-block border-btm text-center">
        <div class="container">
		<a href="#" class="label-link">
		<span class="label label-post">Latest Post</span>Kill your blog: Why side projects are the future of marketing</a>
		</a>
        </div>
      </div>-->
	 <!-- Start Full Width Section 1 -->
      ...
      <div class="grey-bg bg-lg">
        <div class="container">
			<!-- <h2 class="text-primary text-center">We’ll create and deliver your new differentiated experiences. Let us help you transform into a digital leader.</h2> -->
<h2 class="text-primary text-center">We take digital experiences to the next level!</h2>
      <div class="row">
			<div class="col-md-4">
			<div class="panel-icn-center text-center">
			<img src="img/servc-icn1.jpg" alt="" class="icon-panel">
			<h5 class="text-primary">Design Thinking & Ideation</h5>
      <h6 class="text-primary"><i>Think. Create. Validate. Iterate.</i></h5>
			<!-- <p class="text-tertiary">We identify engagement opportunities, define goals, Plan user studies, analyze user information and make recommendations.</p> -->
      <p class="text-tertiary">Visualize your ideas and refine your thinking for the best path forward. We bring design thinking into agile programs and help stakeholder teams embrace a user centric model for digital product design.</p>
      </div>
			</div>
			<div class="col-md-4">
			<div class="panel-icn-center text-center">
			<img src="img/servc-icn2.jpg" alt="" class="icon-panel">
			<h5 class="text-primary">Product Design & Experience Engineering</h5>
      <h6 class="text-primary"><i>Bring Innovation to Your New Experience</i></h5>
			<!-- <p class="text-tertiary">With measurable objectives, we merge experience, usability, color, gestures and branding to envision user engagement and experiences</p> -->

      Bring Innovation to Your New Experience

      <p class="text-tertiary">We bring best practices and out of the box thinking as well as our proven methodology to help you design and develop awesome digital products and experiences.</p>
      </div>
			</div>
			<div class="col-md-4">
			<div class="panel-icn-center text-center">
			<img src="img/servc-icn3.jpg" alt="" class="icon-panel">
			<h5 class="text-primary">Design Systems & Patterns</h5>
      <h6 class="text-primary"><i>Beyond the styleguides</i> </h5>
			<!-- <p class="text-tertiary">With action set as milestones, sprint plans reviewed, test cases created and usability tests conducted @ every stage, deliver exceeding expectations!</p> -->
<p class="text-tertiary">Enabling your organization to evolve CX and UX – while gaining speed to market. This entails design and style elements, design patterns, guidelines that speak to rationale behind it and governance to implement and manage.</p>
      </div>
			</div>
...
<div class="big-title">
              ...
              <div class="col-md-4">
              <a href="contact.php" class="btn-system btn-large btn">Contact Us</a>
              </div>
			  <!--<div class="contact-form">
				...
				<div class="col-md-2">
				<a href="#" class="btn-system btn-large btn">Contact Us</a>
				</div>
				</div>
				</div>-->
</div>
			  ...
			  <ul>
				...
				<li><a href="about.html"><i class="fa fa-angle-right"></i> About us</a></li>
				 <li><a href="services.html"><i class="fa fa-angle-right"></i> Services</a></li>
				  ...
				  <li><a href="ourwork.html"><i class="fa fa-angle-right"></i> Our Work</a></li>
