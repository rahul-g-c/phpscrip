...
<head>
	...
	<title>Claritiz Innovations | Digital UX UI Design Studio</title>
	<meta name="description" content="We Help Incubate Products for Startups and Corporates">
	<meta name="keywords" content="Claritiz, Innovation workshops, Build your startup, Startup Workshop, Startup Consulting, Skunkworks Lab, React Native, React, No SQL, Idea workshops, User research, Market Validation, Mobile Applications, UI Technologies, design factors, user experience, technologies, outsourced, user centered design, usability, UCD, product, development, offshore, india, bangalore, coimbatore, web, products, iOS, Android, iPhone, iPad, " />
...
<!-- End Google Tag Manager -->
    ...
    <!-- Header -->
    <header class="hdr-bg2">
        <div class="container">
            <div class="intro-text">
            <br><br>
                <!--<h1 class="intro-lead-in"><span>We work as a Skunkworks Lab</span>Using emerging tech & User centric design<span>to solve corporate problems at startup speed</span></h1>
                --><h1 class="intro-lead-in">Handcrafting <span>Amazing Digital Experiences </span>for Today's Businesses </h1>
                <div class="intro-cont">We Envision, Design and Incubate products that people love</div><br><br><br>
    ...
    <div class="row hdr-bgpanel1">
                        <div class="col-md-2 col-md-offset-1 col-sm-2 col-sm-offset-1 col-xs-6">
<img src="img/clients/cl-intuit.png" alt="" style="width: 50%">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-6">
<img src="img/clients/cl-edureka.png" alt="" style="width: 50%">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-6">
<img src="img/clients/cl-flip.png" alt="" style="width: 50%">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-6">
<img src="img/clients/cl-slicket.png" alt="" style="width: 50%">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-6" >
<img src="img/clients/cl-verifone.png" alt="" style="width: 50%">
                        </div>
</div>
	 ...
	 <!-- Start Full Width Section 1 -->
      ...
      <div class="grey-bg bg-lg">
        ...
        <div class="col-md-6">
			...
			<h5 class="text-primary">Idea to Prototype</h5>
      <ul>
      <li>Accelerated Innovation Workshop</li>
      <li>Just Enough Research</li>
      <li>Design Sprint & Concepts</li>
      <li>Pixel Perfect CLick-thru Prototype</li>
      <li><br>Typically 2-4 Weeks</li>
      <!-- <li>Starts from USD 5000*</li> -->
      </ul></div>
			</div>
			<div class="col-md-6">
			<div class="panel-icn-center text-center">
			<img src="img/servc-ss.png" alt="" class="icon-panel" height="96" width="96">
			<h5 class="text-primary">Idea to MVP</h5>
    ...
    <li>No Code / Low code apps</li>
    <li>Mobile Front Ends / BAAS</li>
    <li>Continuous Iterations / Experiments </li>

    <li><br>Typically start - go LIVE in 2 weeks</li>
    <!-- <li>Starts from USD 10000*</li> -->
    </ul>
  </div>
			</div>
			<!-- <div class="col-md-4">
			...
			<h5 class="text-primary">Deliver</h5>
...
<img src="img/clients/cl-verifone.png" alt="" style="width: 70%">
                      ...
                      <div class="row">
                        <div class="col-md-2 col-md-offset-1 col-sm-2 col-sm-offset-1 col-xs-6 bordtop">
